...
| 4 | Planning docs 00–05 | 2,3 | main | done |
...
| 17 | Testing + security review + fixes | 10–16 | sub (sec) + main | done |
| 18 | UX/demo review + first-open polish | 12–16 | sub (ux) + main | done |
| 19 | README + evidence map | 17,18 | main | done |
| 20 | Planning docs 06–11 | 17,18 | main | done |
...
5 → 7 → 8 → 9 → 10 (parser must be correct and tested before UI is worth building). UI (12–15) can only show honest metrics once 9 is real. Reviews (17,18) gate documentation (19,20). Audit (22) gates "done".
